...
var Waves = class extends base_default {
  ...
  getMaterial() {
    const options = {
      ...
      flatShading: true,
      vertexColors: THREE2.FaceColors,
  ...
  onInit() {
    ...
    const geometry = new THREE2.Geometry();
    this.gg = [];
    for (i = 0; i <= this.ww; i++) {
      this.gg[i] = [];
      for (j = 0; j <= this.hh; j++) {
        const id = geometry.vertices.length;
        const newVertex = new THREE2.Vector3((i - this.ww * 0.5) * CELLSIZE, rn(0, this.waveNoise) - 10, (this.hh * 0.5 - j) * CELLSIZE);
    ...
    for (i = 1; i <= this.ww; i++) {
      for (j = 1; j <= this.hh; j++) {
        ...
        if (ri(0, 1)) {
          face1 = new THREE2.Face3(a, b, c);
          face2 = new THREE2.Face3(b, c, d);
        } else {
          face1 = new THREE2.Face3(a, b, d);
          face2 = new THREE2.Face3(a, c, d);
        }
    ...
    this.camera = new THREE2.PerspectiveCamera(35, this.width / this.height, 50, 1e4);
    const xOffset = -10;
    const zOffset = -10;
...
// dep:vanta_src_vanta_waves
var vanta_src_vanta_waves_default = vanta_waves_default;
export {
  vanta_src_vanta_waves_default as default
};
//# sourceMappingURL=vanta_src_vanta_waves.js.map
